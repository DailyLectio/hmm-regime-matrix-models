...
- Morning: `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\V3C_START.bat`
- EOD: `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\V3C_EOD.bat`

For V3D:

- Morning: `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\V3D_START.bat`
- EOD: `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\V3D_EOD.bat`

All-model performance export:
...
- [ ] Double-click `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\V3D_EOD.bat`.
- [ ] Wait for V3D shutdown/report/archive to complete.
- [ ] Confirm the V3D report was created in `V3D\Reports`.
- [ ] Double-click `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\V3C_EOD.bat`.
...
1. Shut down V3D.
2. Shut down V3C.
3. Run all-model export.
4. Review reports.

## End Of Week

- [ ] After Friday EOD export is complete, double-click `C:\Users\Valued Customer\NT8_Regimes\Master_Keys\ALL_MODELS_EOW_EXPORT.bat`.
- [ ] Confirm `UNIFIED\AllModels_TradeLog_ALL.csv` was refreshed.
- [ ] Confirm `UNIFIED\Reports\EOW_Trade_Performance_YYYYMMDD.md` was created.
