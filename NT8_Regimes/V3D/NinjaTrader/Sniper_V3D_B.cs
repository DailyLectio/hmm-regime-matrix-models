...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class Sniper_V3D_B : Strategy
    {
        ...
        public string AccountNameFilter { get; set; } = "SimV3D-NQ-4B";
        ...
        public string ConfiguredStrategyName { get; set; } = "Sniper_V3D_B";
        ...
        private volatile bool   simTestingMode   = false;
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                SetupFileWatcher();
                v3dTradeLogger = new V3DStrategyTradeLogger(this, AccountNameFilter, ConfiguredStrategyName, "V3D", TradeLogFolder, "V3D_Sniper_B", "B");
        ...
        private void ReadLatestRow()
        {
            for (int attempt = 0; attempt < 3; attempt++)
            {
                try
                {
                    ...
                    sniperSizePct    = GetIAny(row, "SniperSizePct", "AllowSniper_SizePct");
                    regimeConfidence = (int)GetD(row, "RegimeConfidence");
                    simTestingMode   = GetI(row, "SimTestingMode") == 1;
