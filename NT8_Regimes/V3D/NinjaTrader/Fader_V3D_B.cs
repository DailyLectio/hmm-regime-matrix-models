...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class Fader_V3D_B : Strategy
    {
        ...
        public string AccountNameFilter { get; set; } = "SimV3D-NQ-3B";
        ...
        public string ConfiguredStrategyName { get; set; } = "Fader_V3D_B";
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                SetupFileWatcher();
                v3dTradeLogger = new V3DStrategyTradeLogger(this, AccountNameFilter, ConfiguredStrategyName, "V3D", TradeLogFolder, "V3D_Fader_B", "B");
        ...
        private void ReadLatestRow()
        {
            for (int attempt = 0; attempt < 3; attempt++)
            {
                try
                {
                    ...
                    faderSizePct   = GetIAny(row, "PineSizePct", "AllowPine_SizePct");
