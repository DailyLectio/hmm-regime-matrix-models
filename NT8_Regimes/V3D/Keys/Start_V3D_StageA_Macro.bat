...
echo V3D Stage A MacroRegime live feed
echo Writes: %V3D_DIR%\NQ_Macro_Regimes_V3D.csv and ES_Macro_Regimes_V3D.csv
echo.
cd /d "%V3D_DIR%"
"%PYTHON_EXE%" %PYTHON_ARGS% "%SCRIPTS_DIR%\MacroRegimeBuilder_V3D.py" --live --symbol BOTH --interval 30
pause
